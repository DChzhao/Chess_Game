...
namespace Chess_Game
{
    ...
    internal delegate void WarningTime();
    enum Piece { 
    BPAWN,
    WPAWN,
    BKNIGHT,
    ...
    class ChessGame : INotifyPropertyChanged
    {
        ...
        internal event WarningTime TenSecLeft;
        ...
        private SoundPlayer MovePiece = new SoundPlayer(Properties.Resources.Move);
        private SoundPlayer Capture = new SoundPlayer(Properties.Resources.Capture);
        private SoundPlayer Check = new SoundPlayer(Properties.Resources.Check);
        private SoundPlayer Mate= new SoundPlayer(Properties.Resources.Mate);
        private SoundPlayer Stalemate = new SoundPlayer(Properties.Resources.stalemates);
      //private SoundPlayer TenSecLeft = new SoundPlayer(Properties.Resources.time);
        ...
        internal string TimeToString(long milisec)
        {
            ...
            if ((milisec <= 10000) && (milisec % 1000 == 0))
                TenSecLeft.Invoke();
            result += (milisec / 1000);
            result += ".";
        ...
        internal bool Move(Move move)//If the move is not legal, returns false, otherwise, it makes the move and returns true...
        {
            ...
            if ((move.Checkmate == true) || (move.Stalemate == true))
                GameOver = true;
